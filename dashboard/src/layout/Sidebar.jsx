...
const Sidebar = ({ showSidebar, setShowSidebar }) => {
  ...
  return (
    <div>
      ...
      ></div>
      <div
        className={`w-[260px] fixed bg-[#ededed] z-50 top-0 h-screen shadow-[0_0_15px_0_rgb(34_41_47_/_5%)] transition-all ${
            ...
            {allNav.map((n, i) => (
              <li key={i}>
                <Link
                  ...
                  className={`${
                    pathname === n.path
                      ? "bg-[#4e5447] shadow-green-500/30 text-white duration-500"
                      : "text-green-950 font-normal duration-200"
