            ...
            <div className="w-full h-[calc(100vh-177px)] bg-[#ffffff] md:bg-transparent overflow-y-auto">
              ...
              {sellers.map((s, i) => (
                <Link
                  ...
                  className={` h-[60px] flex justify-start gap-2 items-center text-[#3c3840] px-2 py-2 rounded-md cursor-pointer ${
                    sellerId === s._id ? "bg-[#4e5447] text-white" : ""
                  }`}
                >
            ...
            <div className="flex justify-between items-center">
              {sellerId && (
                <div className="flex justify-start items-center gap-3">
                  ...
                  <span className="text-slate-600">{currentSeller?.name}</span>
                </div>
              )}
              <div
                onClick={() => setShow(!show)}
