    ...
    <div className="w-full bg-white">
          ...
          <div className="flex w-full justify-between items-center h-[50px] text-slate-800">
            ...
            <div>
              <div className="flex justify-center items-center gap-10">
                ...
                <div className="flex group cursor-pointer text-slate-800 text-sm justify-center items-center gap-1 relative after:absolute after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px] before:absolute before:h-[18px] before:bg-[#afafaf] before:w-[1px] before:-left-[20px]">
                  <img src="http://localhost:3000/images/language.png" alt="" />
                  <span>
                    <MdOutlineKeyboardArrowDown />
                  </span>
                  <ul className="group-hover:visible group-hover:top-6 group-hover:bg-black z-10 absolute invisible transition-all top-12 rounded-sm duration-200 text-white p-2 w-[100px] flex flex-col gap-3">
                    <li>Bangla</li>
                    <li>English</li>
                  </ul>
                </div>
      ...
      <div className="hidden md-lg:block">
        <div
          ...
          } hidden md-lg:block w-screen h-screen bg-[rgba(0,0,0,0.5)] z-20 top-0 left-0`}
        ></div>
        <div
          className={`w-[300px] z-[9999] transition-all duration-200 fixed ${
            showSidebar ? "-left-[300px]" : "left-0"
          } overflow-y-auto bg-white h-screen py-6 top-0 px-8`}
        >
          <div className="flex justify-start flex-col gap-6">
            ...
            <ul className="flex flex-col justify-start items-start gap-3 text-[#1c1c1c]">
              <li className="flex justify-start items-center gap-2  text-sm">
                ...
                <span>jaidmonwar.edu@gmail.com</span>
              </li>
              <span className="text-sm">Agro Ecommerce</span>
            </ul>
          </div>
        </div>
      </div>
