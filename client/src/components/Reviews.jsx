        ...
        {[1, 2, 3, 4, 5, 6].map((r, i) => (
          <div key={i} className="flex flex-col gap-1">
            <div className="flex justify-between items-center">
              ...
              <span className="text-slate-600">7 January, 2024</span>
            </div>
            <span className="text-slate-600 text-md">Jaid Monwar</span>
            <p className="text-slate-600 text-sm">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis
              rerum aut aliquid, culpa nisi delectus similique nemo sunt?
              Tempore eligendi cumque hic voluptatibus dicta repudiandae odio
              accusantium neque, quod provident?
            </p>
          </div>
        ))}
        ...
        {userInfo ? (
          <div className="flex flex-col gap-3">
            ...
            <form action="">
              ...
              ></textarea>
              <div className="mt-2">
                <button className="py-1 px-5 bg-violet-700 text-white rounded-sm">
                  Submit
                </button>
              </div>
            </form>
          ...
          <div>
            <Link
              className="py-1 px-5 bg-violet-700 text-white rounded-sm"
              to="/login"
            >
              Login
            </Link>
