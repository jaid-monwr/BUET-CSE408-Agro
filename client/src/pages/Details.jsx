    ...
    const obj = [
      {
        ...
        shopNaem: product.shopName,
        price: quantity * (price - Math.floor((price * 10) / 100)),
        products: [
          {
            quantity,
            productInfo: product,
          ...
          <div className="grid grid-cols-2 md-lg:grid-cols-1 gap-8">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="text-2xl text-red-500 font-bold flex gap-3">
                {product.discount !== 0 ? (
                  <>
                    <h2 className="line-through">Tk {product.price}</h2>
                    <h2>
                      Tk{" "}
                      {product.price -
                ...
                {product.stock ? (
                  <>
                    ...
                    <div>
                      <button
                        onClick={add_cart}
                        className="px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-purple-500/40 bg-violet-700 text-white"
                      >
                        Add to Cart
                      </button>
                    </div>
              ...
              <div className="flex py-5 gap-5">
                ...
                <div className="flex gap-3">
                  {product.stock ? (
                    <button
                      onClick={buy}
                      className="px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-orange-500/40 bg-orange-500 text-white"
                    >
                      Buy Now
                    </button>
                  ) : (
                    ...
                    return (
                      <Link className="block">
                        ...
                        <div className="flex gap-2">
                          <h2 className="text-violet-800 text-lg font-bold">
                            Tk {p.price}
                          </h2>
