                ...
                <div className="bg-white p-6 shadow-sm rounded-md">
                      ...
                      <form onSubmit={save}>
                        ...
                        <div className="flex md:flex-col md:gap-2 gap-5 w-full text-slate-600">
                          ...
                          <div className="flex flex-col gap-1 mt-3 w-full">
                            <button className="px-3 py-[6px] rounded-sm hover:shadow-violet-700/20 hover:shadow-lg bg-violet-700 text-white">
                              Save
                            </button>
                          </div>
                        </div>
                  ...
                  {res && (
                    <div className="flex flex-col gap-1">
                      ...
                      <p>
                        <span className="bg-violet-200 text-violet-800 text-xs font-md mr-2 px-2.5 py-0.5 rounded">
                          Home
                        </span>
                      ...
                      <p className="text-slate-600 text-sm">
                        Email to jaidmonwr.edu@gmail.com
                      </p>
                    </div>
                  )}
                </div>
                        ...
                        <div className="flex sm:w-full gap-2 w-7/12">
                          <div className="flex gap-2 justify-start items-center">
                            ...
                            <div className="pr-4 text-slate-600 ">
                              ...
                              <span className="text-sm">Brand : Rashid</span>
                            </div>
                          </div>
                        </div>
                        <div className="flex justify-end w-5/12 sm:w-full sm:mt-3 ">
                          <div className="pl-4 sm:pl-0 ">
                            <h2 className="text-lg text-orange-500">Tk 655</h2>
